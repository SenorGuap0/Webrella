document.addEventListener('DOMContentLoaded',function(){
  ...
  style.textContent=`
    ...
    .hero{grid-template-columns:minmax(0,.92fr) minmax(0,1.08fr)!important}
    .hero-copy{min-width:0!important;overflow:visible!important;position:relative!important;z-index:3!important}
    .hero-art-image{min-width:0!important;min-height:620px!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;background:var(--cream)!important;padding:18px!important}
    .hero-art-image img{display:block!important;width:100%!important;height:auto!important;max-width:100%!important;max-height:584px!important;object-fit:contain!important;object-position:center center!important;border-radius:0!important}
    ...
    @media(max-width:1050px){
      ...
      .hero-art-image{min-height:auto!important;padding:20px 5vw 40px!important}
      .hero-art-image img{max-height:none!important;width:min(100%,920px)!important}
    ...
    @media(max-width:760px){
      .hero-art-image{padding:10px 16px 28px!important}
      .hero-art-image img{width:100%!important}
