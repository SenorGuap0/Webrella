document.addEventListener('DOMContentLoaded', function () {
  ...
  contactStyle.textContent = `
    ...
    @media(min-width:1121px){
      .header-inner{display:grid!important;grid-template-columns:1fr auto 1fr;align-items:center;position:relative}
      ...
      .site-nav{grid-column:3;grid-row:1;justify-self:end;margin-left:0!important}
    ...
    @media(max-width:1280px) and (min-width:1121px){.header-wordmark{font-size:2rem}.site-nav ul{gap:0}.site-nav a{padding-left:8px;padding-right:8px;font-size:.82rem}}
