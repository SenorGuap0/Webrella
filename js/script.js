document.addEventListener('DOMContentLoaded', function () {
  ...
  contactStyle.textContent = `
    ...
    .header-wordmark{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:2;color:#171717;text-decoration:none;font-size:2.15rem;font-weight:900;letter-spacing:-.06em;line-height:1;transition:transform .2s ease,opacity .2s ease;white-space:nowrap}
    ...
    @media(max-width:1280px){.header-wordmark{font-size:1.8rem}.site-nav ul{gap:0}.site-nav a{padding-left:9px;padding-right:9px}}
